...
public class StyleDictionaryClass {
    ...
    public static let colorBaseRed = UIColor(red: 1.000, green: 0.941, blue: 0.000, alpha: 1)
    public static let colorFontBase = UIColor(red: 1.000, green: 0.941, blue: 0.000, alpha: 1)
